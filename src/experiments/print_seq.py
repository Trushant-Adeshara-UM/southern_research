...
def write_file(cnt, ref_line_width, print_speed, width_error, updated_line_width):
    ...
    data4 = str(cnt) + " Line Width: " + str(updated_line_width)
...
if __name__ == '__main__':
    ...
    print_speed, _width_error = ctrl.process_model(ref_line_width)


    write_file_(cnt, ref_line_width, print_speed) 
    ...
    for location in update_print_location:
        ...
        test.move_to_camera()
        updated_line_width = test.linear_estimator(1, -line_length, 0.3)
